...
2. **Excel-native implementation follows the completed professionalization boundary.** Excel Phase 0/readiness, the approved shared foundation, and the bounded RFQ/Purchase Order pilot are implemented. The next implementation direction is Projects and project controls, reusing the proven shared Excel contracts.
...
4. **Excel Phase 0/readiness, Excel-Native Phase 1, and the bounded Procurement pilot are complete.** Continue with Projects and project controls while preserving real bidirectional `.xlsx` round trips, validation, permissions, history, financial authority, stale-workbook conflict review, and human confirmation before apply.
...
3. **Excel-Native Operations UX — ACTIVE ROLLOUT.** The canonical design is `docs/superpowers/specs/2026-09-18-excel-native-operations-ux-design.md`. Phase 0/readiness, the shared foundation, and the RFQ/Purchase Order pilot are implemented; Projects and project controls are the next bounded rollout.
