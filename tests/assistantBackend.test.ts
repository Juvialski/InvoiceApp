...
const requestedTools = [
  ...
  "get_invoice_settlement", "get_supplier_invoice_payment_options", "get_payroll_settlement", "list_open_invoice_settlements", "get_financial_transaction_settlements", "navigate_to_financial_transaction", "navigate_to_payroll_run", "prepare_supplier_invoice_payment", "prepare_match_transaction_to_invoice", "prepare_match_transaction_to_payroll", "prepare_split_transaction_allocation", "prepare_reverse_financial_settlement",
