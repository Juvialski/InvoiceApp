...
const requestedTools = [
  ...
  "search_work_entries", "prepare_save_project_assignment", "prepare_save_compensation_profile", "prepare_save_recurring_component", "prepare_save_work_entry", "prepare_financial_account", "prepare_financial_account_lifecycle", "prepare_financial_transaction", "prepare_financial_transaction_correction", "prepare_financial_transaction_lifecycle", "prepare_import_cash_statement", "prepare_internal_transfer", "prepare_internal_transfer_reversal", "prepare_update_company_profile", "get_company_access_summary", "prepare_authorize_company_member", "prepare_update_company_member", "prepare_update_member_permissions", "prepare_revoke_company_invitation",
...
test("Assistant registry contains only the requested allowlisted tools through financial settlement integration", () => {
  ...
  assert.doesNotMatch(ASSISTANT_SYSTEM_PROMPT, /InvoiceApp/i);
});
