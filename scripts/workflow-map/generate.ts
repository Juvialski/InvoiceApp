...
export function renderWorkflowMapMarkdown(graph: WorkflowGraph): string {
  const lines: string[] = [
    "# HydroQualiSense Application Workflow Map",
    "",
  ...
  lines.push("", "## Exploratory architecture input", "", "GitDiagram was used only to accelerate repository discovery. The following record preserves what was useful and what required domain-specific correction before becoming HydroQualiSense context.", "");
