...
| `rfi-detail-desktop-1440.png` | Project RFI detail for `demo-rfi-wh-001` | 1440 x 900 | Deterministic safe-demo detail fixture renders the intended populated workflow. |
| `submittal-detail-desktop-1440.png` | Project Submittal detail for `demo-sub-wh-014`, round `demo-round-wh-014-2` | 1440 x 900 | Deterministic safe-demo detail fixture renders the intended populated workflow. |
