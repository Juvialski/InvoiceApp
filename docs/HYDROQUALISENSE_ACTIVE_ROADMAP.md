...
5. **UI-R4E — app-wide rollout + professional certification: AFTER REL-AUTH-1.** Apply the approved shared grammar to remaining existing routes and certify both light and dark themes across the standard four viewports, including keyboard/accessibility and visual inspection.
