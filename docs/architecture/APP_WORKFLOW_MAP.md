...
| **Documents route**<br/><small>`route-documents`</small> | `documents` | `/documents` | `view` | `company` |
...
| **Documents route**<br/><small>`route-documents`</small> | `route` | `company`<br/>`documents`<br/>`/documents`<br/>query: `view` | — | — | `mixed` | `src/utils/routes.ts`<br/>`src/utils/appRouteContracts.ts`<br/>`src/utils/appRouting.ts`<br/>`src/app/routes/AppRouter.tsx`<br/>`src/app/routes/DocumentsRoute.tsx`<br/>`src/components/documents/DocumentCreateView.tsx`<br/>`src/lib/documentRegister.ts` | `tests/navigationRoutes.test.ts`<br/>`tests/appRouting.test.ts`<br/>`tests/documentCenter.test.ts`<br/>`tests/emailSmsDocumentsWorkspace.test.ts` | — |
