...
function summaryFromRpc(value: unknown): FinancialSettlementSummary {
  ...
  return {
    ...
    ...(row.collectionTotal === null || row.collectionTotal === undefined ? {} : { collectionTotal: numberValue(row.collectionTotal) }),
    ...(row.linkedAmount === null || row.linkedAmount === undefined ? {} : { linkedAmount: numberValue(row.linkedAmount) }),
    ...(row.remainingUnlinkedAmount === null || row.remainingUnlinkedAmount === undefined ? {} : { remainingUnlinkedAmount: numberValue(row.remainingUnlinkedAmount) }),
