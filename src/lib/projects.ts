...
function projectRow(project: Project, userId: string, companyId: string) { return companyScopedRow({ id: project.id, user_id: userId, company_id: companyId, project_code: project.projectCode.trim(), project_name: project.projectName.trim(), description: project.description || null, client_name: project.clientName || null, client_reference: project.clientReference || null, billing_contact_name: project.billingContactName || null, billing_email: project.billingEmail || null, billing_address: project.billingAddress || null, location: project.location || null, site_address: project.siteAddress || null, project_manager: project.projectManager || null, status: project.status, start_date: project.startDate || null, target_end_date: project.targetEndDate || null, actual_end_date: project.actualEndDate || null, contract_value: project.contractValue ?? null, project_budget: project.projectBudget || 0, currency: (project.currency || "PHP").toUpperCase(), tax_treatment: normalizeProjectTaxTreatment(project.taxTreatment), notes: project.notes || null, archived_at: project.archivedAt || null, archived_from_status: project.archivedFromStatus || null, updated_at: new Date().toISOString() }); }
