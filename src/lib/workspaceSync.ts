...
export const WORKSPACE_TABLE_REFRESH_GROUPS: Readonly<Record<string, readonly WorkspaceRefreshGroup[]>> = Object.freeze({
  ...
  client_billings: ["engineering"],
  client_billing_lines: ["engineering"],
  client_billing_events: ["engineering"],
  client_collections: ["engineering"],
  client_collection_allocations: ["engineering"],
  client_collection_events: ["engineering"],
  vendors: ["engineering"],
  purchase_orders: ["engineering"],
  purchase_order_lines: ["engineering"],
  purchase_order_receipts: ["engineering"],
  purchase_order_receipt_lines: ["engineering"],
  purchase_order_invoice_matches: ["engineering"],
  purchase_order_invoice_match_lines: ["engineering"],
  rfqs: ["engineering"],
  rfq_lines: ["engineering"],
  rfq_invited_vendors: ["engineering"],
  supplier_quotations: ["engineering"],
  supplier_quotation_lines: ["engineering"],
  subcontracts: ["engineering"],
  subcontract_lines: ["engineering"],
  subcontract_progress_claims: ["engineering"],
  subcontract_progress_claim_lines: ["engineering"],
  subcontract_variations: ["engineering"],
  subcontract_variation_lines: ["engineering"],
  engineering_project_materials: ["engineering"],
  engineering_project_equipment: ["engineering"],
  engineering_equipment_registry: ["engineering"],
  engineering_equipment_assignments: ["engineering"],
  engineering_equipment_events: ["engineering"],
  inventory_items: ["engineering"],
  inventory_movements: ["engineering"],
  engineering_daily_site_logs: ["engineering"],
  engineering_daily_site_log_weather: ["engineering"],
  engineering_daily_site_log_crew: ["engineering"],
  engineering_daily_site_log_equipment: ["engineering"],
  engineering_daily_site_log_work: ["engineering"],
  engineering_daily_site_log_material_deliveries: ["engineering"],
  engineering_daily_site_log_issues: ["engineering"],
  engineering_daily_site_log_safety: ["engineering"],
  engineering_daily_site_log_events: ["engineering"],
  engineering_daily_site_log_addenda: ["engineering"],
  departments: ["payroll"],
  workers: ["payroll"],
