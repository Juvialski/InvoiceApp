...
const BASE_ROUTE_QUERY_KEYS: Partial<Record<RouteId, readonly string[]>> = {
  ...
  inbox: ["view", "documentType", "documentId", "from"],
};
...
export const APP_ROUTE_CONTRACTS: readonly AppRouteContract[] = Object.freeze([
  ...
  },
  {
    id: "project-billing",
    routeId: "projects",
    canonicalPath: "/projects/:projectId/billing",
    pathPattern: "/projects/:projectId/billing",
    queryKeys: ["billingId"],
    scope: "production-and-demo",
  },
  {
  ...
  },
  {
    id: "expense-detail",
    routeId: "expenses",
    canonicalPath: "/expenses?expenseId=:expenseId",
    pathPattern: "/expenses",
    queryKeys: ["expenseId", "from"],
    scope: "production-and-demo",
  },
  {
    id: "review-invoice",
