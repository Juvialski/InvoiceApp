...
export const PERMISSION_KEYS = {
  ...
  procurementWrite: "procurement.manage",
  ...
  projectScheduleManage: "scheduling.manage",
...
export const ROUTE_PERMISSION_REQUIREMENTS: Readonly<Partial<Record<AppTab, PermissionKey>>> = Object.freeze({
  ...
  procurement: PERMISSION_KEYS.procurementRead,
...
export function permissionDisplayName(permission: PermissionKey | null | undefined): string {
  const labels: Record<string, string> = {
    ...
    [PERMISSION_KEYS.procurementWrite]: "Purchase Order editing",
    [PERMISSION_KEYS.procurementApprove]: "Purchase Order approval and issuance",
    [PERMISSION_KEYS.inventoryRead]: "Warehouse inventory",
    [PERMISSION_KEYS.inventoryManage]: "Warehouse inventory management",
    [PERMISSION_KEYS.equipmentRead]: "Equipment Registry",
    [PERMISSION_KEYS.equipmentManage]: "Equipment Registry management",
    ...
    [PERMISSION_KEYS.projectScheduleManage]: "Project schedule management",
