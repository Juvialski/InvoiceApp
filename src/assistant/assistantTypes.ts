...
export interface AssistantClientAction {
  type: "NAVIGATE" | "OPEN_INVOICE" | "OPEN_PROJECT" | "OPEN_PROJECT_DOCUMENTS" | "OPEN_ENGINEERING_DOCUMENT" | "OPEN_RFI" | "OPEN_SUBMITTAL" | "OPEN_SITE_LOG" | "OPEN_REVIEW_INVOICE" | "START_TOUR" | "OPEN_PAYROLL_PERIOD" | "OPEN_PAYROLL_RUN" | "OPEN_FINANCIAL_TRANSACTION" | "OPEN_ATTENDANCE_DATE";
  routeId?: string;
  entityId?: string;
  projectId?: string;
  roundId?: string;
