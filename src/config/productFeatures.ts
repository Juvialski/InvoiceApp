...
export const CLIENT_PRODUCT_FEATURES: readonly ProductFeatureDefinition[] = Object.freeze([
  ...
  },
  {
    ...
    details: [
      ...
      "Correct permitted extracted header, supplier-evidence, line-item, and monetary facts beneath the preserved source document while canonical links and verification remain controlled.",
  ...
  },
  {
    ...
    status: "AVAILABLE",
    shortDescription: "Create and revise draft client progress billings, issue invoices, record partial or full collections, and follow each invoice's receivable history.",
    details: [
      "Edit draft billing details and line items in a spreadsheet-familiar worksheet while totals, project context, currency, tax treatment, and lifecycle actions remain protected.",
  ...
  },
  {
    ...
    status: "AVAILABLE",
    shortDescription: "Use one communications workspace for reviewed outbound email, delivery history, provider status, SMS status, and a permission-aware Documents center.",
    details: [
  ...
  },
  {
    ...
    details: [
      ...
      "Send issued Purchase Orders and Client Invoices through the configured Brevo account using the exact supported PDF for that snapshot.",
  ...
  },
  {
    ...
    category: "Email & Document Intake",
    status: "PLANNED",
    shortDescription: "Choose the recommended Company SIM Gateway or the low-cost hosted PhilSMS alternative for controlled Philippine SMS.",
    details: [
      "Company SIM Gateway uses the company's Android phone and SIM while the phone remains available for normal use.",
      "PhilSMS provides a hosted Philippine SMS option with no minimum top-up under its current Standard offering; account pricing and Sender ID approval remain provider requirements.",
      "SMS stays limited to one reviewed transactional recipient per send, with safe status handling and provider-backed QA required before activation.",
    ],
    sortOrder: 210,
  },
  {
