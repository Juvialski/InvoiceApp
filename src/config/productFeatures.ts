...
export const CLIENT_PRODUCT_FEATURES: readonly ProductFeatureDefinition[] = Object.freeze([
  ...
  },
  {
    ...
    status: "AVAILABLE",
    shortDescription: "Use one communications workspace for read-only Gmail intake, reviewed outbound email, delivery history, and a permission-aware Documents center.",
    details: [
