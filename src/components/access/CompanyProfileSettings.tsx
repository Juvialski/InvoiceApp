      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 max-w-2xl text-xs leading-5 text-slate-500">This deployment has one client company. Update the company name, default currency, and deployment timezone used across {currentWorkspacePresentation().productName}.</p>
          </div>
        </div>
