...
import { convertFinancialAmount, displayFinancialAmountInPhp, findFinancialFxSnapshot, normalizeFinancialCurrency } from "../../utils/financialCurrency.ts";
...
function expenseAmountForPhp(expense: Expense, invoice: InvoiceData | undefined, snapshots: readonly FinancialFxSnapshot[]) {
  ...
  return displayFinancialAmountInPhp(expense.amount, expense.currency, "SUPPLIER_INVOICE", invoice.id, snapshots);
}
