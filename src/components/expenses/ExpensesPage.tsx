...
export const ExpensesPage: React.FC<ExpensesPageProps> = ({ expenses, projects, costCodes = [], onSave, onPreviewCorrection, onApplyCorrection, initialProjectId, initialExpenseId, onInitialCorrectionConsumed }) => {
