...
export const ExpensesPage: React.FC<ExpensesPageProps> = ({ expenses, projects, invoices = [], purchaseOrders = [], vendors = [], costCodes = [], onSave, onPreviewCorrection, onApplyCorrection, initialProjectId, initialExpenseId, onInitialCorrectionConsumed }) => {
