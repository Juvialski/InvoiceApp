...
export const ExpensesPage: React.FC<ExpensesPageProps> = ({
  ...
  return <div className="space-y-5">
    ...
    {supplierDocuments.length > 0 && <section className="space-y-3" aria-label="Supplier document work">
      ...
      {needsReviewDocuments.length > 0 && <SupplierDocumentSection title="Supplier documents requiring review or completion" rows={needsReviewDocuments} projects={projects} onFix={onFixSupplierInvoice} onOpenReview={onOpenSupplierInvoiceReview} />}
