...
export const Reports: React.FC<ReportsProps> = ({ invoices, fxSnapshots = [], baseCurrency = "PHP", settlementProjections, today }) => {
  ...
  return <div className="space-y-5">
    <PageHeader eyebrow="Operational reporting" title="Reports" description="Review source activity, payment status, and reporting readiness with currencies intact." />
