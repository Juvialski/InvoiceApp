    ...
    <div className="max-w-4xl space-y-5">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4 sm:p-5">
        ...
        <div className="grid sm:grid-cols-2 gap-3 mt-5">
          <div className="rounded-xl bg-slate-50 p-3 flex items-center gap-2"><MapPin className="w-3.5 h-3.5 text-indigo-600" /><span className="text-xs">Country: <strong>Philippines</strong></span></div>
          <div className="rounded-xl bg-slate-50 p-3 flex items-center gap-2"><Globe2 className="w-3.5 h-3.5 text-indigo-600" /><span className="text-xs">Locale: <strong>en-PH</strong></span></div>
          <div className="rounded-xl bg-slate-50 p-3 flex items-center gap-2"><span className="w-3.5 text-center text-indigo-600 font-black">₱</span><span className="text-xs">Currency: <strong>PHP</strong></span></div>
          <div className="rounded-xl bg-slate-50 p-3 flex items-center gap-2"><Clock3 className="w-3.5 h-3.5 text-indigo-600" /><span className="text-xs">Timezone: <strong>Asia/Manila</strong></span></div>
        </div>
