...
export const ReviewPanel: React.FC<ReviewPanelProps> = ({ invoice, onVerify, onReopen, onRevertToAI, onFocusField, onRevertField, verifyLabel = "Mark verified" }) => {
  ...
  return <div data-tour="review-fields" className={`rounded-2xl border p-4 shadow-sm ${needsReview ? "bg-amber-50 border-amber-200" : "bg-emerald-50 border-emerald-200"}`}>
