  ...
  return (
    <section className="space-y-5" data-domain="equipment-registry">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="hidden grid-cols-[minmax(220px,1.35fr)_150px_150px_minmax(190px,1fr)_150px_minmax(220px,1.2fr)] gap-3 border-b border-slate-100 bg-slate-50 px-4 py-3 text-[10px] font-black uppercase tracking-wide text-slate-500 lg:grid"><span>Asset</span><span>Type / source</span><span>Current state</span><span>Current Project</span><span>Field evidence</span><span /></div>
        {filtered.length ? filtered.map((item) => {
          ...
          return <div key={item.id} className="grid gap-3 border-b border-slate-100 px-4 py-4 last:border-b-0 lg:grid-cols-[minmax(220px,1.35fr)_150px_150px_minmax(190px,1fr)_150px_minmax(220px,1.2fr)] lg:items-center">
