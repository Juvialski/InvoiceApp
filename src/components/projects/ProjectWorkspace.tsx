...
export const ProjectWorkspace: React.FC<ProjectWorkspaceProps> = ({
  ...
  const canReadEquipment = engineeringDocumentsGuestMode || hasPermission(permissions, PERMISSION_KEYS.equipmentRead);
  ...
  return (
    <div className="space-y-5">
      ...
      <div data-ux45c="project-workspace-active-surface">
      ...
      {tab === "materials-equipment" && <ProjectMaterialsEquipment project={project} materials={materials} equipment={equipment} canonicalEquipment={canReadEquipment ? canonicalEquipment : []} equipmentAssignments={equipmentAssignments} inventoryItems={inventoryItems} inventoryMovements={inventoryMovements} inventoryBalances={inventoryBalances} purchaseOrders={purchaseOrders} receipts={receipts} vendors={vendors} costCodes={costCodes} dailySiteLogsData={projectDailySiteLogsData} canReadSiteLogs={canReadSiteLogs} canReadProcurement={canReadProcurement} canReadInventory={canReadInventory} canReadEquipment={canReadEquipment} canManage={canManageProject} guestMode={engineeringDocumentsGuestMode} onOpenSiteLogs={() => selectTab("site-logs")} onOpenWarehouse={canReadInventory ? onOpenWarehouse : undefined} onSaveMaterial={onSaveMaterial} onSaveEquipment={onSaveEquipment} />}
