...
function buildAssignment(invoice: InvoiceData, project: Project, allAllocations: InvoiceProjectAllocation[], amount: number) {
...
export const ExistingInvoicePicker: React.FC<ExistingInvoicePickerProps> = ({ project, invoices, allocations, onAssign, onClose }) => {
  ...
  const assignSelected = async () => {
    ...
    for (const row of selectedRows) {
      ...
      try {
        await onAssign(row.invoice, buildAssignment(row.invoice, project, row.allocations, amount));
        succeeded += 1;
