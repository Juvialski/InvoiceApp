...
export const ProjectInvoices: React.FC<ProjectInvoicesProps> = ({ project, invoices, allocations, costCodes = [], onOpenInvoice, onUploadInvoice, onSaveAllocations }) => {
  ...
  return <>
    ...
    {pickerOpen && <ExistingInvoicePicker project={project} invoices={invoices} allocations={allocations} costCodes={costCodes} onAssign={onSaveAllocations} onClose={() => setPickerOpen(false)} />}
