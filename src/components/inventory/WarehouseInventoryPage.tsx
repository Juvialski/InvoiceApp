...
import { ActionButton, DisclosureSection, PageActionBar, PageHeader, StatusBadge, type StatusTone } from "../ui/OperationsUI.tsx";
...
export const WarehouseInventoryPage: React.FC<WarehouseInventoryPageProps> = ({
  ...
  return (
    <section className="space-y-5" data-domain="warehouse-inventory">
      ...
      <PageHeader eyebrow="Company operations" title="Warehouse Inventory" description="Stock and custody from recorded movements; no valuation is posted here." actions={canManage ? <PageActionBar><ActionButton size="sm" variant="primary" icon={<Plus aria-hidden="true" className="h-3.5 w-3.5" />} label="Add item" onClick={() => setItemModal({})} /><ActionButton size="sm" variant="secondary" icon={<ArrowDownToLine aria-hidden="true" className="h-3.5 w-3.5" />} label="Opening stock" onClick={() => openMovement("OPENING")} /></PageActionBar> : undefined} />
