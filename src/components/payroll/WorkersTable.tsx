...
export const WorkersTable: React.FC<WorkersTableProps> = ({
  ...
  const workerCodeInputRef = useRef<HTMLInputElement>(null);
  const workerDialogRef = useDialogFocus({ open: Boolean(editing), onClose: () => setEditing(null), initialFocusRef: workerCodeInputRef });
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm" aria-labelledby="workforce-workers-title">
      <div className="flex items-center justify-between gap-3 border-b border-slate-100 p-5">
        <div>
          <h3 id="workforce-workers-title" className="text-sm font-black">Workers</h3>
      ...
      {workers.length ? (
        <div className="overflow-x-auto">
          <table className="w-full min-w-[980px] text-left text-xs" aria-label="Workforce directory">
            <caption className="sr-only">Workforce directory with active status, labor context, project assignments, pay defaults, and lifecycle actions.</caption>
