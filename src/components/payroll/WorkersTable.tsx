...
export const WorkersTable: React.FC<WorkersTableProps> = ({
  ...
  const save = (event: React.FormEvent) => {
    ...
    if (!editing?.employeeCode.trim() || !editing.firstName.trim() || !editing.lastName.trim()) return;
    onSave({
      ...editing,
