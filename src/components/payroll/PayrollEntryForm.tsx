...
export const PayrollEntryForm: React.FC<PayrollEntryFormProps> = ({ runs, workers, projects, onSave }) => {
  ...
  const start = () => {
    ...
    setDeductions(0);
    setMessage("");
    setAllocations([{ id: localId(), projectId: firstProject?.id || "", percentage: 100 }]);
    setOpen(true);
  };
