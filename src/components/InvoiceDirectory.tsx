...
export const InvoiceDirectory: React.FC<InvoiceDirectoryProps> = ({ invoices, onSelectInvoice, onOpenCorrection, onAddNew, projects = [], projectAllocations = [], financialFxSnapshots = [], settlementProjections, today }) => {
