...
export function EmailSmsRoute({
  ...
  return (
    <section className="space-y-5" data-email-sms-workspace="true" aria-labelledby="email-sms-workspace-title">
      <PageHeader eyebrow="Company communications" title="Email / SMS" description="One workspace for Gmail intake, outbound message review, audited delivery history, and truthful SMS provider status." actions={<div className="inline-flex items-center gap-2 rounded-lg border border-indigo-100 bg-indigo-50 px-3 py-2 text-[10px] font-black text-indigo-800"><Mail className="h-3.5 w-3.5" />Connected identity stays server-authorized</div>} />
      <h1 id="email-sms-workspace-title" className="sr-only">Email / SMS communications workspace</h1>
