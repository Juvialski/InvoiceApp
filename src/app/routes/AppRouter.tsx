  ...
  if (routeTarget === "projects") {
    return lazyRoute(
      <ProjectsRoute
        ...
        cashData={cashData}
        canReconcileCash={canCashReconcile}
        canSettleClientCollection={canSettleCashTarget ? canSettleCashTarget("CLIENT_COLLECTION") : canCashReconcile}
  ...
  if (routeTarget === "procurement") {
    return lazyRoute(
      <ProcurementRoute
        ...
        initialSubcontractId={procurementContext?.subcontractId}
